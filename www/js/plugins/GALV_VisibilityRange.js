  ...
  Galv.VR.setImage = function (image) {
    if (SceneManager._scene.constructor.name == "Scene_Map") {
      if (SceneManager._scene._spriteset)
        SceneManager._scene._spriteset.doVisSprite(image);
    }
  };

  Galv.VR.zoom = Number(
    PluginManager.parameters("Galv_VisibilityRange")["Zoom Variable"]
  );
  Galv.VR.opacity = Number(
    PluginManager.parameters("Galv_VisibilityRange")["Opacity Variable"]
  );
  Galv.VR.z = Number(
    PluginManager.parameters("Galv_VisibilityRange")["Z Position"]
  );

  //-----------------------------------------------------------------------------
  // Spriteset_Map

  var Galv_Spriteset_Map_createLowerLayer =
