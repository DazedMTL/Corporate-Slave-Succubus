...
(function (_) {
  ...
  Sprite_HUDText.prototype.refresh = function (refreshProperties) {
    ...
    this.bitmap.addLoadListener(
      function () {
        this.bitmap.clear();
        const textLines = this._value.split("\n"); // 텍스트를 줄바꿈 문자('\n')로 나눕니다.
        const lineHeight = this.bitmap.fontSize + 8; // 줄 간격 조정
  ...
  Sprite_HUDText.prototype.refreshProperties = function () {
    ...
    const height = parseInt(this["Font Size"]) + 142; // 간격 임의로 늘림. 쉬프트 +아래로 7번
  ...
  Sprite_HUDTextEx.prototype.resetFontSettings = function () {
    ...
    this.contents.fontSize = 28; // TextEx font size change 이 숫자를 바꾸면 28보다 작을 경우 글자가 올라가고 28보다 클 경우 글자가 내려간다.
