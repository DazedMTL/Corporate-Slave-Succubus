...
(function () {
  ...
  var paramHideMenu =
    (parameters["Hide Menu"] || "True").toLowerCase() === "true";
  var paramHideShop =
    (parameters["Hide Shop"] || "True").toLowerCase() === "true";

  // Categories
  var _Window_ItemList_includes = Window_ItemList.prototype.includes;
  Window_ItemList.prototype.includes = function (item) {
    if (this._category == "all") return true;
    else return _Window_ItemList_includes.call(this, item);
  };
  ...
  // Scene_Shop
  if (paramHideShop) {
    var _Scene_Shop_createCategoryWindow =
