...
(function () {
  ...
  Galv.MB.fadeOutSpeed = Number(
    PluginManager.parameters("Galv_MessageBusts")["Fade Out Speed"]
  );
...
Sprite_GalvBust.prototype.controlBitmap = function () {
  if (
    $gameMessage.faceName() &&
    this.name !== $gameMessage.faceName() + "_" + ($gameMessage.faceIndex() + 1)
  ) {
  ...
  this.opacity = $gameMessage.faceName()
    ...
    : this.opacity - Galv.MB.fadeOutSpeed;
