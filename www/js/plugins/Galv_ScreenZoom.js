...
(function () {
  Galv.ZOOM.battleZoomEnabled =
    PluginManager.parameters("GALV_ScreenZoom")["Enable Battle Zoom"] == "true";
  Galv.ZOOM.battleScale = Number(
    PluginManager.parameters("GALV_ScreenZoom")["Battle Zoom"]
  );
