...
(function () {
  ...
  LiveCommentContainer.prototype.show = function (text, backgroundColor) {
    let lcw = new Window_LiveComment(
      this.yPos,
      this._width,
      text,
      backgroundColor
  ...
  Window_LiveComment.prototype.initialize = function (
    y,
    width,
    text,
    backgroundColor
    ...
    this.drawTextEx(
      text,
      textPadding,
      this.lineHeight() / 2 - this.standardFontSize() / 2 - 4
    );
  ...
  Window_LiveComment.prototype.processDrawIcon = function (
    iconIndex,
    textState
  ) {
