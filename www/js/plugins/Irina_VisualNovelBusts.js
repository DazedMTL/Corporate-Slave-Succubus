...
(function (t) {
  ...
  Imported.Irina_VisualNovelBusts.BustDimValues = [
    parseInt(i[0]),
    parseInt(i[1]),
    parseInt(i[2]),
    parseInt(i[3]),
  ...
  Imported.Irina_VisualNovelBusts.BustLightValues = [
    parseInt(n[0]),
    parseInt(n[1]),
    parseInt(n[2]),
    parseInt(n[3]),
  ...
  for (
    var e = 0;
    e < Imported.Irina_VisualNovelBusts.BustExpressionList.length;
    e++
  ) {
    Imported.Irina_VisualNovelBusts.BustExpressionList[e] =
      Imported.Irina_VisualNovelBusts.BustExpressionList[e]
        .toUpperCase()
        .trim();
  }
...
if (Imported.Irina_VisualNovelBusts.BustAutoClear) {
  Imported.Irina_VisualNovelBusts.Game_Interpreter_terminate =
...
Sprite_VisualNovelBust.prototype.resetSettings = function () {
  this.anchor.x =
    Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].AnchorX;
  this.anchor.y =
    Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].AnchorY;
  if (this._setting > 0) {
    this.x =
      Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].ScreenX.call(
        this
      );
    this.y =
      Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].ScreenY.call(
        this
      );
  }
...
Sprite_VisualNovelBust.prototype.updateRepeatingAnimation = function () {
  if (this._repeatingAnimationId > 0 && !this.isAnimationPlaying()) {
    this.startAnimation(
      $dataAnimations[this._repeatingAnimationId],
      this._repeatingAnimationMirror,
      this._repeatingAnimationDelay
    );
  }
};
...
Sprite_VisualNovelBust.prototype.applyEasing = function (t, e) {
  ...
  switch (e) {
    ...
    case "INOUTQUART":
      var r = t - 1;
      return t < 0.5 ? 8 * t * t * t * t : 1 - 8 * r * r * r * r;
      break;
    case "INQUINT":
      return t * t * t * t * t;
      break;
    ...
    case "INOUTQUINT":
      var r = t - 1;
      return t < 0.5 ? 16 * t * t * t * t * t : 1 + 16 * r * r * r * r * r;
      break;
    case "INEXPO":
      if (t === 0) {
        return 0;
    ...
    case "INOUTBACK":
      ...
      var u = a * 1.525;
      if (i < 1) {
        return 0.5 * i * i * ((u + 1) * i - u);
      }
      return 0.5 * (o * o * ((u + 1) * o + u) + 2);
      break;
    case "INELASTIC":
      if (t === 0 || t === 1) {
        return t;
    ...
    case "INOUTELASTIC":
      ...
      if (i < 1) {
        return (
          -0.5 * (Math.pow(2, 10 * n) * Math.sin(((n - u) * (2 * Math.PI)) / p))
        );
      }
      return (
        Math.pow(2, -10 * n) * Math.sin(((n - u) * (2 * Math.PI)) / p) * 0.5 + 1
      );
      break;
    case "OUTBOUNCE":
      var i = t / 1;
...
Sprite_VisualNovelBust.prototype.moveHome = function (t, e) {
  ...
  var s =
    Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].ScreenX.call(a);
  var r =
    Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].ScreenY.call(a);
  this.moveTo(s, r, t, e);
};
...
Sprite_VisualNovelBust.prototype.resetScaleSettings = function () {
  this.scale.x =
    Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].ScaleX;
  this.scale.y =
    Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].ScaleY;
  this._scaleTargetX =
    Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].ScaleX;
  this._scaleTargetY =
    Imported.Irina_VisualNovelBusts.BustDefaults[this._setting].ScaleY;
...
Sprite_VisualNovelBust.prototype.setExpression = function (t) {
  ...
  if (Imported.Irina_VisualNovelBusts.BustExpressionList.contains(t)) {
    this._expressionIndex =
      Imported.Irina_VisualNovelBusts.BustExpressionList.indexOf(t);
  } else {
...
Imported.Irina_VisualNovelBusts.Spriteset_Base_createUpperLayer =
...
Spriteset_Base.prototype.createMessageBustSprites = function () {
  this._messageBustSprites = [
    null,
    (this._messageBustSprite1 = new Sprite_VisualNovelBust(1)),
    (this._messageBustSprite2 = new Sprite_VisualNovelBust(2)),
    (this._messageBustSprite3 = new Sprite_VisualNovelBust(3)),
    (this._messageBustSprite4 = new Sprite_VisualNovelBust(4)),
    (this._messageBustSprite5 = new Sprite_VisualNovelBust(5)),
    (this._messageBustSprite6 = new Sprite_VisualNovelBust(6)),
    (this._messageBustSprite7 = new Sprite_VisualNovelBust(7)),
    (this._messageBustSprite8 = new Sprite_VisualNovelBust(8)),
    (this._messageBustSprite9 = new Sprite_VisualNovelBust(9)),
    (this._messageBustSprite10 = new Sprite_VisualNovelBust(10)),
  ];
...
Imported.Irina_VisualNovelBusts.Window_Base_convertEscapeCharacters =
...
Window_Base.prototype.convertEscapeCharacters = function (t) {
  ...
  return Imported.Irina_VisualNovelBusts.Window_Base_convertEscapeCharacters.call(
    this,
    t
  );
};
...
Window_Base.prototype.convertMessageBustEscapeCharacters = function (text) {
  ...
  text = text.replace(
    ...
    function () {
      ...
      var a =
        t[1] === undefined
          ? Imported.Irina_VisualNovelBusts.BustClearDuration
          : parseInt(t[1]) || 0;
      e.clear(a);
      return "";
    }.bind(this)
  ...
  text = text.replace(
    /\x1bBUST(?:ANI|ANIMATION)\[(.*?)\]/gi,
    function () {
      var array = arguments[1].split(",");
      var sprite = $bust(parseInt(array[0]));
      var animation =
        $dataAnimations[this.getBattleAnimationForBustCode(array[1])];
  ...
  text = text.replace(
    /\x1bBUST(?:REP|REPEAT|REPEATING)(?:ANI|ANIMATION)\[(.*?)\]/gi,
    function () {
      var array = arguments[1].split(",");
      var sprite = $bust(parseInt(array[0]));
  ...
  text = text.replace(
    /\x1bBUST(?:STOP|CLEAR)(?:ANI|ANIMATION)\[(\d+)\]/gi,
    function () {
  ...
  text = text.replace(
    ...
    function () {
      ...
      var r =
        t[3] === undefined
          ? Imported.Irina_VisualNovelBusts.BustMoveDuration
          : parseInt(t[3]) || 0;
      e.moveTo(a, s, r);
      return "";
    }.bind(this)
  ...
  text = text.replace(
    ...
    function () {
      ...
      var a =
        t[1] === undefined
          ? Imported.Irina_VisualNovelBusts.BustFadeDuration
          : parseInt(t[1]) || 0;
      e.fadeIn(a);
      return "";
    }.bind(this)
  ...
  text = text.replace(
    ...
    function () {
      ...
      var s =
        t[2] === undefined
          ? Imported.Irina_VisualNovelBusts.BustOpacityDuration
          : parseInt(t[1]) || 0;
      e.opacityTo(a, s);
      return "";
    }.bind(this)
  ...
  text = text.replace(
    ...
    function () {
      ...
      var a =
        t[1] === undefined
          ? Imported.Irina_VisualNovelBusts.BustSlideDuration
          : parseInt(t[1]) || 0;
      e.slideIn(a);
      return "";
    }.bind(this)
  ...
  text = text.replace(
    ...
    function () {
      ...
      var a =
        t[1] === undefined
          ? Imported.Irina_VisualNovelBusts.BustScaleDuration
          : parseFloat(t[1]) || 0;
      var s =
        t[2] === undefined
          ? Imported.Irina_VisualNovelBusts.BustScaleDuration
  ...
  text = text.replace(
    ...
    function () {
      ...
      var n =
        t[5] === undefined
          ? Imported.Irina_VisualNovelBusts.BustToneDuration
          : parseInt(t[5]) || 0;
      e.setTone(a, s, r, i, n);
      return "";
    }.bind(this)
  ...
  text = text.replace(
    /\x1bBUST(?:INDEX|EXP|EXPRESSION)\[(.*?)\]/gi,
    function () {
      var t = arguments[1].split(",");
      var e = $bust(parseInt(t[0]));
...
Imported.Irina_VisualNovelBusts.Window_Base_processEscapeCharacter =
...
Window_Base.prototype.processEscapeCharacter = function (code, textState) {
  if (code.match(/BUSTMSG(?:ANI|ANIMATION)/i)) {
    ...
    Imported.Irina_VisualNovelBusts.Window_Base_processEscapeCharacter.call(
      this,
      code,
      textState
    );
...
Imported.Irina_VisualNovelBusts.Window_Message_initMembers =
...
Window_Message.prototype.isUsingFaceBust = function () {
  ...
  if (
    $gameMessage.allText().match(/\\BUST\[(\d+)\]/i) ||
    $gameMessage.allText().match(/\x1bBUST\[(\d+)\]/i)
  )
    return true;
  return false;
};
Imported.Irina_VisualNovelBusts.Window_Message_loadMessageFace =
...
Imported.Irina_VisualNovelBusts.Window_Message_drawMessageFace =
...
Window_Message.prototype.makeMessageWindowBust = function (t) {
  this._messageBodyBustSprite.x =
    Imported.Irina_VisualNovelBusts.BustDefaults[0].ScreenX.call(this);
  this._messageBodyBustSprite.y =
    Imported.Irina_VisualNovelBusts.BustDefaults[0].ScreenY.call(this);
  this._messageBodyBustSprite.loadBitmap("face", t);
};
Imported.Irina_VisualNovelBusts.Window_Message_newLineX =
...
Imported.Irina_VisualNovelBusts.Window_Message_isTriggered =
